...
void emit() {
  //; 820108C4 915F005C stw      r10, r31, 92
  //v230.i32<gpr0> = truncate v225.i64<gpr0>
  //v231.i32<gpr0> = byte_swap v230.i32<gpr0>
  //v227.i64<gpr1> = load_context +264
  //v228.i64<gpr1> = add v227.i64<gpr1>, 5C
  //store v228.i64<gpr1>, v231.i32<gpr0>

  // mov eax, rbx
  // bswap eax
  // mov dword_ptr[ctx+(264+5Ch)], eax

  // addr = load_context +264
  // addr = add addr, 5Ch
  // store addr, ...
}
